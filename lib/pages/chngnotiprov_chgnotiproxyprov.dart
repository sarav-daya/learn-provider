...
class ChngNotProvChgNotiProxyProv extends StatelessWidget {
  const ChngNotProvChgNotiProxyProv({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Chg NotiProv & Chg NotiProxProv'),
        elevation: 0.0,
      ),
      body: Center(
        child: MultiProvider(
